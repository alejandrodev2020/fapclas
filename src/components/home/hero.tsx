            ...
            >
              ...
              <Box>
                ...
                <Typography variant="subtitle1" sx={{ color: 'text.secondary', lineHeight: 1.3 }}>
                  Cooperativa certificada y regulada  por la entidad fiscalizadora AFCOOP.
                </Typography>
              </Box>
            </Box>
            <Box sx={{ lineHeight: 0 }}>
              {/* <Image
                src="https://credilinea.co/wp-content/uploads/image-165.png.webp"
                width={775}
                height={787}
                alt="Hero img"
              /> */}
              <img
                style={{ height: '350px' }}
                src="https://www.pngkit.com/png/full/57-576770_happy-man-holding-in-his-hand-bundles-of.png"
                alt=""
              />
            </Box>
          </Grid>
